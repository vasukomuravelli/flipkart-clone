        ...
        <div class="col-md-7">
            <div class="inner_row">
                <div class="col">  
                    ...
                    <p class="mb-1"> Flipkart Stroies </p>
                    <p class="mb-1"> Press </p>
                    <p class="mb-1"> Flipkart Wholesale </p>
                    <p class="mb-1"> Corporate Information </p>
                </div>  
                ...
                <div class="col">
                    ...
                    <p class="mb-1"> Cancellations & returns </p>
                    <p class="mb-1"> FAQ </p>
                    <p class="mb-1"> Report Infringement </p>
                </div> 
                ...
                <div class="col">
                    ...
                    <p class="mb-1"> Sitemap </p>
                    <p class="mb-1"> EPR Compliance </p>
                </div>
...
<div class="row">
    <div class="flex_footer"> 
        <div>
            ...
            <p class = "mb-1">Sell On Flipkart</p>
        </div>
...
function Flipkartinfo()
{
    ...
    <p>
        ...
        <br>
        <br>    What's more, you can even use the Flipkart supercoins for a number of exciting services, like:
